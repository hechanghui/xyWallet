...
class DropRecord extends BaseWidget {
  @override
  getState() => _State();
}

class _State extends BaseLoadListDataWidgetState<DropRecord, PowByAttractionMoreDataViewModel> {
  @override
  String titleLabel(BuildContext context) => S.of(context).dropRecord;
