...
class _PinyinPage extends State<CountryListPage> {
  ...
  void convertToPinyin(String text) {
    switch (_convertType) {
      case TYPE_PINYIN:
        try {
          _pinyinResult = PinyinHelper.getPinyin(text, separator: " ", format: _pinyinFormat);
        } catch (ex) {
              ...
              children: <Widget>[
                new Row(
                  ...
                  children: <Widget>[
                    new Padding(
                      ...
                      child: new Column(
                        children: <Widget>[
                          new Text("带声调", style: new TextStyle(fontSize: 12.0, color: Colors.grey[700])),
                          new Checkbox(
                              value: (_pinyinFormat == PinyinFormat.WITH_TONE_MARK && _convertType == TYPE_PINYIN),
                              onChanged: (value) {
                                if (value) {
                                  setState(() {
                    ...
                    new Padding(
                      ...
                      child: new Column(
                        children: <Widget>[
                          new Text("不带声调", style: new TextStyle(fontSize: 12.0, color: Colors.grey[700])),
                          new Checkbox(
                              value: (_pinyinFormat == PinyinFormat.WITHOUT_TONE && _convertType == TYPE_PINYIN),
                              onChanged: (value) {
                                if (value) {
                                  setState(() {
                                    _convertType = TYPE_PINYIN;
                    ...
                    new Padding(
                      ...
                      child: new Column(
                        children: <Widget>[
                          new Text("带数字声调", style: new TextStyle(fontSize: 12.0, color: Colors.grey[700])),
                          new Checkbox(
                              value: (_pinyinFormat == PinyinFormat.WITH_TONE_NUMBER && _convertType == TYPE_PINYIN),
                              onChanged: (value) {
                                if (value) {
                                  setState(() {
                                    _convertType = TYPE_PINYIN;
                                    _pinyinFormat = PinyinFormat.WITH_TONE_NUMBER;
                                    convertToPinyin(_inputText);
                                  });
                                }
                              })
                    ...
                    new Padding(
                      ...
                      child: new Column(
                        children: <Widget>[
                          new Text("繁->简", style: new TextStyle(fontSize: 12.0, color: Colors.grey[700])),
                          new Checkbox(
                    ...
                    new Padding(
                      ...
                      child: new Column(
                        children: <Widget>[
                          new Text("简->繁", style: new TextStyle(fontSize: 12.0, color: Colors.grey[700])),
                          new Checkbox(
                ...
                new Container(
                  ...
                  child: new TextField(
                    ...
                    decoration: new InputDecoration(hintText: "请输入...", hintStyle: new TextStyle(fontSize: 14.0)),
                    onChanged: (value) {
                      textChange(value);
                    },
                  ),
